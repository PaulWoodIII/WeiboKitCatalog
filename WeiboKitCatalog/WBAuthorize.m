...
- (void)requestAccessTokenWithAuthorizeCode:(NSString *)code
{
    NSDictionary *params = [NSDictionary dictionaryWithObjectsAndKeys:appKey, @"client_id",
                                                                      ...
                                                                      code, @"code", nil];
    NSString *urlString = [NSString stringWithFormat:@"%@%@",kWBAccessTokenURL, [params stringWithFormEncodedComponents]];
    AFHTTPClient *client = [[AFHTTPClient alloc] initWithBaseURL:[NSURL URLWithString:kWBAccessTokenURL]];
    [client postPath:[NSString stringWithFormat:@"access_token?%@",[params stringWithFormEncodedComponents]]
          parameters:nil
...
//
//    
//    NSString *urlString = [NSString stringWithFormat:@"%@/%@", kWBAuthorizeURL, [params stringWithFormEncodedComponents]];
